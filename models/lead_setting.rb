...
#  email_auto_respond                  :boolean          default(FALSE)
...
#  parse_cinc_leads                    :boolean          default(FALSE)
#  parse_emails_with_inbox             :boolean          default(FALSE)
#  parse_moxie_leads                   :boolean          default(FALSE)
#  parse_realtor_leads                 :boolean          default(FALSE)
#  parse_trulia_leads                  :boolean          default(FALSE)
#  parse_zillow_leads                  :boolean          default(FALSE)
...
class LeadSetting < ActiveRecord::Base
  ...
  ATTRS_TO_UPDATE_ON_SUBSCRIPTION_DEACTIVATE = [
    "forward_lead_to_group",
    "broadcast_lead_to_group",
    "parse_trulia_leads",
    "parse_realtor_leads",
    "parse_zillow_leads",
    "parse_moxie_leads",
